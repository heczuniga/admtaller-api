...
@router.get("/api/usuario/lista", response_model=List[dict], name="Recupera un usuario en base a su Id")
def usuario_lista():
    d: List[Usuario]
...
@router.get("/api/usuario/{id_usuario}", response_model=dict, name="Recupera un usuario en base a su Id")
def usuario_get(id_usuario: int):
    u: Usuario
...
@router.delete("/api/usuario/eliminar/{id_usuario}", response_model=dict, name="Elimina un usuario y retorna si hubo o no éxito")
...
@router.put("/api/usuario/{id_usuario}", response_model=dict, name="Modificar un usuario")
